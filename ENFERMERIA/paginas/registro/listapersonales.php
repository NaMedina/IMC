...
die($message);
			...
			while ($rowTotal = $resultados->fetch_assoc())
			{
				?>
                    ...
                    <td><a href="fichacom.php?id_per=<?php echo $rowTotal["id_persona"]; ?>">ver</a></td>
                    <td><?php 
...
and diagnostico.id_persona=$persona";
                    ...
                    $resultados2 = $mysqli->query($query2);
					 $rowTotal2 = $resultados2->num_rows;
					...
					?>Aplicar</a></td>
                     ...
                     <td><a href="formulariocom2.php?id_per=<?php echo $rowTotal["id_persona"]; ?>">Eliminar</a></td>                    
                     </tr>
                  <?php
